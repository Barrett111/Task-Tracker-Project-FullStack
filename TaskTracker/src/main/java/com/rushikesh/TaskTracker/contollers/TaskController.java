package com.rushikesh.TaskTracker.contollers;

import com.rushikesh.TaskTracker.domain.dto.TaskDto;
import com.rushikesh.TaskTracker.domain.entities.Task;
import com.rushikesh.TaskTracker.mappers.TaskMapper;
import com.rushikesh.TaskTracker.services.TaskService;
...
public class TaskController {
    ...
    //for editing or new individual tasks
    @PostMapping
    public TaskDto createTask(@PathVariable("task_list_id")UUID taskListId,
                              @RequestBody TaskDto taskDto){
        Task createdTask=taskService.createtasks(taskListId,taskMapper
                .fromDto(taskDto));
