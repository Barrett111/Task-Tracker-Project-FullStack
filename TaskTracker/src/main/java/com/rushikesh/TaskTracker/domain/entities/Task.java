...
public class Task {
    ...
    @Column(name="id",updatable = false,nullable = false) //ID CANNOT UPDATE, CANNOT BE NULL
    private UUID id;
    ...
    //RELATIONSHIP IN TASK AND TASKLISTS
    @ManyToOne(fetch=FetchType.LAZY)
    @JoinColumn(name="task_list_id") //refering to foreign key in TaskList table
    private TaskList taskList;  //A SINGLE TASK
